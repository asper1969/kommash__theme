...
$(document).ready(function () {
    ...
    if ($('.content__suffix #block-views-block-table-block-1 .content').length) {
        ...
        $('.content__suffix #block-views-block-table-block-1 ' + '.content').niceScroll({
            autohidemode: false,
            cursorwidth: 17,
...
var mainSlider = {
    ...
    init: function init() {
        ...
        if (ww < 768) {
            ...
            var $titles = this.settings.slideTitle.closest('.views-row').parent();
            var $slides = this.settings.slideImage.parent();
